...
export default function Referrals() {
  ...
  const handleWhatsAppShare = () => {
    const text = `🚀 I'm using Ascend to supercharge my job search with AI! Build optimized profiles for LinkedIn, Indeed & more. Join me: ${referralLink}`;
    window.open(`https://wa.me/?text=${encodeURIComponent(text)}`, "_blank");
  };

  const handleLinkedInShare = () => {
    const text = `I've been using Ascend to optimize my professional profiles and job search with AI. Highly recommend checking it out!`;
    window.open(
