          ...
          <div className="prose prose-gray max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 leading-relaxed">
                By accessing or using Ascend by Coheron ("Ascend," "Service," "Platform"), you agree to 
            ...
            {/* Section 2 */}
            <section className="mb-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-3">2. Description of Ascend by Coheron</h2>
              <p className="text-gray-600 leading-relaxed">
