      ...
      <div className="w-full max-w-2xl bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden">
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <AscendMark size={40} variant="white" />
            <div style={{ display: 'flex', flexDirection: 'column', gap: '7px', lineHeight: 1 }}>
              <span style={{
              ...
              <CoheronMark width={108} fill="rgba(255,255,255,0.55)" accentFill="rgba(255,255,255,0.25)" />
            </div>
          </div>
          ...
          <div className="border border-slate-200 rounded-xl overflow-hidden">
            ...
            <div className="max-h-[300px] overflow-y-auto p-4 text-sm text-slate-600 leading-relaxed space-y-4 bg-white">
              <EulaSection title="1. Acceptance of Terms">
                By accessing or using Ascend by Coheron ("the Service"), you agree to be bound by these Terms 
              ...
              <EulaSection title="2. Description of Service">
                Ascend by Coheron is a career acceleration platform that provides AI-powered profile optimization, 
              ...
              <EulaSection title="3. Data Collection and Usage">
                <strong>For Free Tier Users:</strong> By using the Free tier, you grant Ascend by Coheron the 
          ...
          <div className="space-y-4 pt-2">
            ...
            <div className="flex items-start gap-3 p-3 rounded-lg border border-slate-200 hover:bg-slate-50 transition-colors">
              ...
              <Label htmlFor="marketing" className="text-sm text-slate-600 cursor-pointer leading-relaxed">
                I'd like to receive career tips, product updates, and offers from Ascend by Coheron
