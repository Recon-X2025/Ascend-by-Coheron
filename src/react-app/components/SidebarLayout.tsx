      ...
      <aside className="hidden lg:flex print:hidden w-60 border-r border-border bg-card flex-col fixed h-full">
        ...
        <div className="border-b border-border">
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', padding: '16px' }}>
            <AscendMark size={32} variant="color" />
            <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', lineHeight: 1 }}>
              <span style={{
              ...
              <CoheronMark width={96} fill="#0A0A0A" accentFill="#1A7A4A" />
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between px-4 py-3">
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '4px', lineHeight: 1 }}>
              ...
              <CoheronMark width={82} fill="#0A0A0A" accentFill="#1A7A4A" />
            </div>
          </div>
          <Button 
            variant="ghost" 
